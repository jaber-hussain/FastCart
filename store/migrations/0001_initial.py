# Generated by Django 4.2 on 2025-09-12 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(blank=True, choices=[('Cash on Delivery', 'Cash on Delivery'), ('Credit Card', 'Credit Card')], default='None', max_length=100, null=True)),
                ...
                ('initial_total', models.DecimalField(blank=True, decimal_places=2, default=0.0, help_text='Total amount before applying coupon', max_digits=12, null=True)),
                ('saved', models.DecimalField(blank=True, decimal_places=2, default=0.0, help_text='Total amount saved by applying coupon', max_digits=12, null=True)),
                ('order_id', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', length=6, max_length=25, prefix='OID-', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='product.png', null=True, upload_to='image')),
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', length=5, max_length=50, prefix='SKU-', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_status', models.CharField(choices=[('Pending', 'Pending'), ('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Fulfilled', 'Fulfilled'), ('Cancelled', 'Cancelled')], default='Pending', max_length=100)),
                ('shipping_service', models.CharField(blank=True, choices=[('Standard Shipping', 'Standard Shipping'), ('Express Shipping', 'Express Shipping')], default='None', max_length=100, null=True)),
                ...
                ('item_id', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', length=6, max_length=25, prefix='IID-', unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='gallery.png', upload_to='images')),
                ('gallery_id', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', length=6, max_length=10, prefix='GID-', unique=True)),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store.product')),
            ],
        ),
        migrations.CreateModel(
