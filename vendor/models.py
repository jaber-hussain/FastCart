...
class Vendor(models.Model):
    ...
    image = models.ImageField(upload_to='images', default='shop-image.png', blank=True)
    store_name = models.CharField(max_length=100, null=True, blank=True)
    is_approved = models.BooleanField(default=False)
    description = models.TextField(null=True, blank=True)
    country = models.CharField(max_length=100, null=True, blank=True)
    vendor_id = ShortUUIDField(length=6, max_length=20, prefix='vnd-', unique=True, alphabet='1234567890')
...
class Payout(models.Model):
    ...
    item = models.ForeignKey('store.OrderItem', on_delete=models.SET_NULL, null=True, related_name='payout_item')
    amount = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
    payout_id = ShortUUIDField(length=6, max_length=20, prefix='pyt-', unique=True, alphabet='1234567890')
    date = models.DateTimeField(auto_now_add=True)
